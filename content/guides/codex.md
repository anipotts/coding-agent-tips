...
### terminal and editor keep the code close
...
### instructions, tools, and permissions shape the loop
...
### some of the harness can be changed
...
## finish with an artifact you can inspect
